...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "nolita@mergington.edu"]
    },
    "Basketball Club": {
    ...
    "Art Studio": {
        "description": "Create drawings, paintings, and mixed media art",
    ...
    "Debate Team": {
        ...
        "schedule": "Mondays and Thursdays, 5:00 PM - 6:15 PM",
        "max_participants": 14,
    ...
    "Math Olympiad": {
        ...
        "max_participants": 15,
        "participants": ["li@mergington.edu", "emma@mergington.edu"]
    }
}
